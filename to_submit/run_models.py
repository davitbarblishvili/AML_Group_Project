...
results = results.append(
    lr(train_x, train_y, test_x, test_y), ignore_index=True)
# SVM
results = results.append(
    run_SVM(train_x, train_y, test_x, test_y), ignore_index=True)
# KNN
results = results.append(
    run_knn(20, 2, train_x, train_y, test_x, test_y), ignore_index=True)
# Naive Bayes
results = results.append(
    run_GNB(train_x, train_y, test_x, test_y), ignore_index=True)
# Random Forest
results = results.append(run_random_forest_smote(
    train_x, train_y, test_x, test_y), ignore_index=True)
# CNN
results = results.append(
    cnn(train_x, train_y, test_x, test_y), ignore_index=True)
